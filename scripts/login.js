(function($){
    ...
    $('#create').click(function(){ 
        ...
        var name=$('#register-confirm-code').val().trim();
        var pwd=$('#register-pwd').val().trim();
        var home=$('#register-pwd2').val().trim();
        ...
        if(name==""){ 
            $('#register-code-error').text('用户名不能为空');
            return false;
        }
        if(pwd==""){
        ...
        if(home==""){
            $('#register-pwd2-error').text('住址不能为空');
            return false;
        }
    ...
    $('#checkin').click(function(event){ 
        ...
        if(phone==""){ 
            $('#login-phone-error').text('用户账号不能为空');
            return false;
        }
        if(pwd==""){
            $('#login-pwd-error').text('用户密码不能为空');
            return false;
        }
        checkin(phone,pwd);
    });
